...
if("TRUE" STREQUAL "TRUE")
  set(robot_navigation_SOURCE_PREFIX /home/trobot/robot_ws/src/robot_navigation)
  set(robot_navigation_DEVEL_PREFIX /home/trobot/robot_ws/devel)
  ...
  set(robot_navigation_INSTALL_PREFIX /home/trobot/robot_ws/install)
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'robot_navigation' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  Ask the maintainer 'cantao <2580419863@qq.com>' to fix it.")
      endif()
    else()
      message(FATAL_ERROR "Project 'robot_navigation' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/trobot/robot_ws/src/robot_navigation/${idir}'.  Ask the maintainer 'cantao <2580419863@qq.com>' to fix it.")
    endif()
...
foreach(depend ${depends})
  ...
  if(${count} EQUAL 1)
    ...
    if(NOT ${robot_navigation_dep}_FOUND)
      find_package(${robot_navigation_dep} REQUIRED)
    endif()
  else()
    # dependencies with components must be find_package()-ed again
    list(REMOVE_AT depend_list 0)
    find_package(${robot_navigation_dep} REQUIRED ${depend_list})
  endif()
