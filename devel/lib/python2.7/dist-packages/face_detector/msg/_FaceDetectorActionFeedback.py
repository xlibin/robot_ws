...
"""autogenerated by genpy from face_detector/FaceDetectorActionFeedback.msg. Do not edit."""
import sys
...
class FaceDetectorActionFeedback(genpy.Message):
  _md5sum = "aae20e09065c3809e8a8e87c4c8953fd"
  _type = "face_detector/FaceDetectorActionFeedback"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','face_detector/FaceDetectorFeedback']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(FaceDetectorActionFeedback, self).__init__(*args, **kwds)
      ...
      if self.feedback is None:
        self.feedback = face_detector.msg.FaceDetectorFeedback()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.feedback = face_detector.msg.FaceDetectorFeedback()
