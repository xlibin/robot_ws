...
echo_and_run cd "/home/trobot/robot_ws/src/wu_ros_tools/kalman_filter"
...
echo_and_run /usr/bin/env \
    ...
    "/usr/bin/python" \
    "/home/trobot/robot_ws/src/wu_ros_tools/kalman_filter/setup.py" \
    build --build-base "/home/trobot/robot_ws/build/wu_ros_tools/kalman_filter" \
    install \
    $DESTDIR_ARG \
