...
class MoveBaseSquare():
	def __init__ (self):
		rospy.init_node('nave_test', anonymous = False)
		...
		# Append each of the four waypoints to the list. Each waypoint is a pose consisting of a position and orientation in the map frame.
